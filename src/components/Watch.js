...
const Watch = () => {
  ...
  const sendMessage = (e) => {
    e.preventDefault();
    dispatch(setMessage({ name: "mayur@44", message: input }));
    setInput("");
  };
  ...
  return (
    <div className="flex ml-4 w-[100%] mt-4">
      <div className="flex w-[88%]">
        <div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center w-[40%] justify-between mt-2 mr-2">
          ...
          <div className="w-[1000px]"><CommentsContainer/></div>
        </div>
        <div className="w-[100%] border border-gray-300 ml-2 rounded-lg h-fit p-4">
